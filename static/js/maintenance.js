...
$(function(){
    $("#neg-color-plus-btn").on("click", function(){
        ...
        let neg_color_elm = '<p>アクセントカラーHSV<input type ="text" name="neg'+next_num_of_colors+'" required="required"> 色の名前<input type ="text" name="neg'+next_num_of_colors+'-name" required="required">-------------------------------------</p>'
...
$(function(){
    $("#pos-color-plus-btn").on("click", function(){
        ...
        let next_num_of_colors = Number(num_of_colors)+1
        $(this).attr('data-num', next_num_of_colors);
        let neg_color_elm = '<p>アクセントカラーHSV<input type ="text" name="pos'+next_num_of_colors+'" required="required"> 色の名前<input type ="text" name="pos'+next_num_of_colors+'-name" required="required">-------------------------------------</p>'
        $(this).prev().after(neg_color_elm);
